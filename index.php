...
<body onload="myfunc()" id="body">
    <!--Navbar-->
<nav class="navbar navbar-expand-lg" id="opaque" style="background-color:  #fff ;">
    ...
    <a href="cart.php" style="float: right;padding:0px;margin: 0px;color: #111111;" class="navbar-toggler">
        <span><i class="fa fa-cart-plus" aria-hidden="true"></i> &nbsp Cart</span>
    </a>
...
<ul class="nav nav-tabs nav-justified indigo webli-list" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link"  href="profilen.php" role="tab" ><i class="fa fa-user"></i><p style="font-size: 12px;">Profile</p> </a>
    </li>
    <li class="nav-item" class="navbar-toggler8" data-toggle="collapse" onclick="openNav()" aria-controls="basicExampleNav"
        aria-expanded="false" aria-label="Toggle navigation">
        <a class="nav-link"><i class="fa fa-heart"></i><p style="font-size: 12px;">Guidance</p> </a>
    </li>
</ul>
<!-- Tab panels -->
...
<br>
    ...
    <h4 class="heading" style="color:#FF6000;display: inline-block;">Recently viewed</h4>
    <h4 class="heading" style="color:#FF6000;float: right;display: inline-block;"><a style="color:#FF6000;" href="books.php">More>></a></h4>
    </div>
  <div class="slider slider-for">
  </div>
  <div class="slider slider-nav" style="height: 95%;">

    <div style="height: 100%;" class="card">
        <div class="book" style="height: 100%;">
            <div class="book-image" style="height: 82%;width: 96%;">
                <img src="img/img1.jpg" style="width: 100%;height: 100%;">
                <!--<p>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#previewbook"><i class="fa fa-user" aria-hidden="true"></i></a>
    ...
    <div style="height: 100%;" class="card">
        <div class="book" style="height: 100%;">
            <div class="book-image" style="height: 82%;width: 96%;">
                <img src="img/img6.jpg" style="width: 100%;height: 100%;">
                <!--<p>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#previewbook"><i class="fa fa-user" aria-hidden="true"></i></a>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#whistlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#cart"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
    ...
    <div style="height: 100%;" class="card">
        <div class="book" style="height: 100%;">
            <div class="book-image" style="height: 82%;width: 96%;">
                <img src="img/img7.jpg" style="width: 100%;height: 100%;">
                <!--<p>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#previewbook"><i class="fa fa-user" aria-hidden="true"></i></a>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#whistlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                    <a style="color: #FF6000;" data-toggle="modal" data-target="#cart"><i class="fa fa-cart-plus" aria-hidden="true"></i></a>
...
<div class="main" style="padding: 10px;">
    <div class="slide-header">
    <h4 class="heading" style="color:#FF6000;display: inline-block;">New to market</h4>
    <h4 class="heading" style="color:#FF6000;float: right;display: inline-block;"><a style="color:#FF6000;" href="books.php">More>></a></h4>
    </div>
  <div class="slider slider-for">
  </div>
  ...
  <div class="main" style="padding: 10px;">
    <div class="slide-header">
    <h4 class="heading" style="color:#FF6000;display: inline-block;">Most viewed</h4>
    <h4 class="heading" style="color:#FF6000;float: right;display: inline-block;"><a style="color:#FF6000;" href="books.php">More>></a></h4>
    </div>
  <div class="slider slider-for">
  </div>
