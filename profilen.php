    ...
    <header id="header">
        ...
        aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="col-md-3 webli-navicons col-sm-12">
                ...
                <a style="color: #FF6000;" data-toggle="modal" href="#whistlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
...
<ul class="nav nav-tabs nav-justified indigo webli-list" role="tablist">
    ...
    <div class="profile" style="margin-top: 130px;height: 100%;">
    	<center style="height: 100%;">
    		<h3>Prakhar Pandey</h3>
    		<h5>prakharpandeyvk@gmail.com</h5><br>
						...
						<div class="row" style="width: 80%;">
							    <div class="col-md-3">
							        <ul class="nav  md-pills pills-primary flex-column tab-list" role="tablist">
							            <li class="nav-item" style="border-right-color:red;border-width: 1px">
							    ...
							    <div class="col-md-9" style="background-color: white;">
							        ...
							        <div class="tab-pane fade" id="panel12" role="tabpanel">
										...
										<div class="md-form">
                                            ...
                                            <select id="form6" style="margin:10px">
